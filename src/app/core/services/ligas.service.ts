...
export class LigasService {
  readonly ligas: LigaHomologada[] = [
   ...
   //: Muchos partidos a la misma hora. { nombrePublico: 'Angola', nombreForApi: 'angola/girabola/', historico: 0,  sofascoreId: 2308, enable: 1 },
    ...
    { nombrePublico: 'China_L2', nombreForApi: 'China_L2/super-league/', historico: 0,  sofascoreId: 10381, enable: 1 },
    ...
    { nombrePublico: 'Mauritania', nombreForApi: 'Mauritania/botola-3/', historico: 0, sofascoreId: 23703, enable: 1 },
    ...
    { nombrePublico: 'Uganda', nombreForApi: 'uganda/premier-league/', historico: 0,  sofascoreId: 10166, enable: 1 },
  ...
  private readonly historicosDisponibles = new Set<string>([
    ...
    'Canada', 'Chile', 'China', 'China_L2', 'Colombia', 'Colombia_B', 'Costa_Rica',
    ...
    'Jordania', 'Kazajistan', 'Korea_del_Sur', 'Kuwait', 'Lituania', 'Mauritania',
    'Marruecos', 'Marruecos_L2', 'Mexico', 'Mexico_Expansion', 'México_Femenil', 'Nicaragua', 'Noruega', 'Panama', 'Paraguay', 'Paraguay_Int',
