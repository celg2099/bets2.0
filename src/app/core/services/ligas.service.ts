...
export class LigasService {
  readonly ligas: LigaHomologada[] = [
   ...
   //: Muchos partidos a la misma hora. { nombrePublico: 'Angola', nombreForApi: 'angola/girabola/', historico: 0,  sofascoreId: 2308, enable: 1 },
    { nombrePublico: 'Arabia_Saudita', nombreForApi: 'saudi-arabia/saudi-professional-league-2025-2026/', historico: 0,  archivoLigas: 'Arabia_Saudita.json', enable: 1 },
    ...
    { nombrePublico: 'Mexico', nombreForApi: 'mexico/liga-mx-apertura/', historico: 0, enable: 1 },
